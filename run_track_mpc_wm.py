...
def parse_args():
    ...
    p.add_argument("--actuator-gain", type=float, default=1.0,
                help="unmodeled actuator efficiency at CONTROL time: truth moves at gain*v. Set to the dataset's gain (e.g. 0.7) so the test matches training; the naive oracle assumes 1 and mis-plans")
